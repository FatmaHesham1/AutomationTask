...
Feature: F01_Register | users can create new accounts
  ...
  Scenario Outline: user could register with all valid data successfully
    ...
    Examples:
      ...
      | Jumiatest100@gmail.com   | automation | tester     | P@ssw0rd&&&     | P@ssw0rd&&&       | 1155508342  | female |
      | Jumiatest200@gmail.com   | jumia      | testerdemo  | 123Password??  | 123Password??     | 1155508342  | male   |